...
public class Order {
  ...
  @SerializedName("_suspectFlags")
  private List<SuspectFlag> _suspectFlags = null;

  @SerializedName("_isSuspicious")
  private Boolean _isSuspicious = null;

  @SerializedName("_suspiciousResolved")
  private Boolean _suspiciousResolved = null;
  ...
  **/
  ...
  public Order _suspectFlags(List<SuspectFlag> _suspectFlags) {
    this._suspectFlags = _suspectFlags;
    return this;
  }

  public Order addSuspectFlagsItem(SuspectFlag _suspectFlagsItem) {
    if (this._suspectFlags == null) {
      this._suspectFlags = new ArrayList<SuspectFlag>();
    }
    this._suspectFlags.add(_suspectFlagsItem);
    return this;
  }

   /**
   * Array of reasons the order is flagged as suspicious
   * @return _suspectFlags
  **/
  @Schema(description = "Array of reasons the order is flagged as suspicious")
  public List<SuspectFlag> getSuspectFlags() {
    return _suspectFlags;
  }

  public void setSuspectFlags(List<SuspectFlag> _suspectFlags) {
    this._suspectFlags = _suspectFlags;
  }

  public Order _isSuspicious(Boolean _isSuspicious) {
    this._isSuspicious = _isSuspicious;
    return this;
  }
  ...
  **/
  @Schema(description = "True indicates if order is flagged as suspicious")
  public Boolean isIsSuspicious() {
    return _isSuspicious;
  }

  public void setIsSuspicious(Boolean _isSuspicious) {
    this._isSuspicious = _isSuspicious;
  }

  public Order _suspiciousResolved(Boolean _suspiciousResolved) {
    this._suspiciousResolved = _suspiciousResolved;
    return this;
  }

   /**
   * True indicates if a suspicous order was approved in the dashboard
   * @return _suspiciousResolved
  **/
  @Schema(description = "True indicates if a suspicous order was approved in the dashboard")
  public Boolean isSuspiciousResolved() {
    return _suspiciousResolved;
  }

  public void setSuspiciousResolved(Boolean _suspiciousResolved) {
    this._suspiciousResolved = _suspiciousResolved;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.orderId, order.orderId) &&
        ...
        Objects.equals(this._suspectFlags, order._suspectFlags) &&
        Objects.equals(this._isSuspicious, order._isSuspicious) &&
        Objects.equals(this._suspiciousResolved, order._suspiciousResolved);
  }

  @Override
  public int hashCode() {
    return Objects.hash(orderId, dateTime, testOrder, orderType, firstName, lastName, email, phone, mobilePhone, street, city, stateProvince, country, postalCode, fees, taxes, donations, grandTotal, coupons, couponsTotal, ipAddress, browserName, browserDevice, sourceCode, searchTag, survey, _transactions, _tickets, _posCashierName, _suspectFlags, _isSuspicious, _suspiciousResolved);
  }
  ...
  public String toString() {
    ...
    sb.append("    _suspectFlags: ").append(toIndentedString(_suspectFlags)).append("\n");
    sb.append("    _isSuspicious: ").append(toIndentedString(_isSuspicious)).append("\n");
    sb.append("    _suspiciousResolved: ").append(toIndentedString(_suspiciousResolved)).append("\n");
    sb.append("}");
    return sb.toString();
  }
