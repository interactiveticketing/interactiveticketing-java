...
public class Ticket {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(ticketId, barcode, canceled, name, details, price, slotDate, slotTime, slotAllDay, nameOnTicket, seatEventTitle, seatVenueTitle, seatSection, seatCustom1, seatCustom2, seatRow, seatRowLabel, seatNumber, seatNumberLabel, seatText, noPrint, noBarcode, discount, fee, tax, refund, promoCode, promoName, promoDescription, _scans, _scanPointConfig);
  }
